...
ANARI_TYPEFOR_SPECIALIZATION(visionaray::int2, ANARI_INT32_VEC2);
ANARI_TYPEFOR_SPECIALIZATION(visionaray::int3, ANARI_INT32_VEC3);
ANARI_TYPEFOR_SPECIALIZATION(visionaray::int4, ANARI_INT32_VEC4);
...
ANARI_TYPEFOR_DEFINITION(visionaray::int2);
ANARI_TYPEFOR_DEFINITION(visionaray::int3);
ANARI_TYPEFOR_DEFINITION(visionaray::int4);
