...
namespace visionaray {
  ...
  VSNRAY_FUNC
  inline mat3 make_LinearSpace3f(const vec3 x, const vec3 y, const vec3 z)
  {
    mat3 l;
    l.col0 = x;
    l.col1 = y;
  ...
  VSNRAY_FUNC
  inline bool intersectWedgeEXT(float &value,
                                const vec3f &P,
                                const float4 _v0,
                                const float4 _v1,
                                const float4 _v2,
